...
export class Building {
    ...
    static getTooltip(tile, name, tier, potential = false) {
        ...
        var prodBonus = 1 + (def * MoonlightData.getInstance().moonperks.moonlightworkers.level * 0.01) * tile.towerBonus;
        ...
        switch (name) {
            ...
            case "Watch Tower":
                var bonus = tier * 2 * (1 + MoonlightData.getInstance().moonperks.construction.level * 0.1);
            ...
            case "Market":
                ...
                var bonus = Math.max(0, Math.min(max, (closest[1] / Statics.TRADE_HOUSE_MAX_DISTANCE) * max)) *
            ...
            case "Docks":
                ...
                var bonus = tier * Statics.DOCK_BASE_ECON * region.townData.getEconomyMulti() * dockEff * tile.towerBonus;
            ...
            case "Warehouse":
                var bonus = tier * (20 * (1 + MoonlightData.getInstance().moonperks.construction.level * 0.1));
            ...
            case "Dojo":
                ...
                var pow = tier * 0.02 * WorldData.getInstance().powerMulti * moonBonus * tile.towerBonus;
                var def = tier * 0.2 * WorldData.getInstance().healthMulti * moonBonus * tile.towerBonus;
